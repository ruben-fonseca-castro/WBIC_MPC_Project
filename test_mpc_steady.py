...
idx = int(np.argmin(np.abs(t - (t[mi] + 2.0))))
...
node.current_fsm_state = node.FSM_LOCOMOTION
...
node.joy_msg.right_stick_x = 0.6609 / -1.0 # Reverse engineer joy_yaw
